...
class MultiheadAttention(nn.MultiheadAttention):
    ...
    def __init__(self, embed_dim: int, num_heads: int,
                 ...
                 add_bias_kv: bool = False, add_zero_attn: bool = False, output_attentions = False,
    ...
    def _forward_impl(self,
        ...
        #print("INSIDE FORWARD OF MULTI-HEAD ATTENTION")
        static_k = None
        static_v = None
        ...
        if attn_mask is not None:
            #print("ATTN MASK TYPE:", type(attn_mask))
        ...
        if key_padding_mask is not None:
            #print("KEY PADDDING MASK TYPE:", type(key_padding_mask))
        ...
        self.attns = attn_output_weights
        ...
        self.attns = self.attns.view(bsz, self.num_heads, self.attns.shape[1], self.attns.shape[2])
